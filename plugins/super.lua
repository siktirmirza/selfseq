...
function get_message_callback(extra, success, result)
	...
	elseif get_cmd == 'cid' and result.action then
...
local function run(msg, matches)
	...
	local data = load_data(_config.moderation.data)
		...
		if matches[1] == 'seedkirhelp' and not is_owner(msg) then
			text = "Message /superhelp to @CheckerBot in private for SuperGroup help"
			reply_msg(msg.id, text, ok_cb, false)
		elseif matches[1] == 'seedkirhelp' and is_owner(msg) then
