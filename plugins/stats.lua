...
local function run(msg, matches)
  if matches[1]:lower() == 'checker' then -- Put everything you like :)
    local about = "برو شب بیا :)"
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "checker" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (checker)",-- Put everything you like :)
		"^[!/]([Cc]hecker)"-- Put everything you like :)
    }, 
  run = run
}
